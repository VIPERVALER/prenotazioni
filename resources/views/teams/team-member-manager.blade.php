<div>
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-form-section submit="addTeamMember">
                ...
                <x-slot name="description">
                    {{ __('Aggiungi un nuovo membro al tuo team.') }}
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            {{ __('Inserisci la sua mail così da aggiungerlo.') }}
                        </div>
                    </div>
                    ...
                    @if (count($this->roles) > 0)
                        <div class="col-span-6 lg:col-span-4">
                            <x-jet-label for="role" value="{{ __('Ruolo') }}" />
    ...
    @if ($team->teamInvitations->isNotEmpty() && Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-action-section>
                ...
                <x-slot name="description">
                    {{ __('Queste persone devono ancora accettare l\'email di invito.') }}
                </x-slot>
    ...
    @if ($team->users->isNotEmpty())
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-action-section>
                ...
                <x-slot name="description">
                    {{ __('Tutte le persone facenti parte del tuo team.') }}
                </x-slot>
    ...
    <x-jet-confirmation-modal wire:model="confirmingTeamMemberRemoval">
        ...
        <x-slot name="content">
            {{ __('Sicuro di voler rimuovere questa persona dal tuo team?') }}
        </x-slot>
